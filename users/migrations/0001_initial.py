    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('users', 'foydalanuvchilar'), ('admin', 'Admin'), ('kuryer', 'yetkazib beruvchi'), ('operator', 'operator'), ('meneger', 'Menedjer')], default='users', max_length=25)),
                ('image', models.ImageField(blank=True, default='1.jpg', null=True, upload_to='images/users')),
